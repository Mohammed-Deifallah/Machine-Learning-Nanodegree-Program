...
def run():
    ...
    epsilon = .5 # continuous value for the exploration factor, default is 1
    ...
    # Run the simulator
    # Flags:
    tolerance    = .05 # epsilon tolerance before beginning testing, default is 0.05 
    n_test = 10
    sim.run()
